...
#define HP203B_CMD_CONVERT \
  (0x40)  // Convert the Sensor Output to the Digital Values
...
#define HP203B_CMD_CHNL_PRESTEMP \
  (0x00)                             // Sensor Pressure and Temperature Channel
